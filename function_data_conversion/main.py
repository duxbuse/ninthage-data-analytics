...
def function_data_conversion(request: Request) -> tuple[dict, int]:
    ...
    # manual game report
    elif file_name == "manual game report":
        try:
...
if __name__ == "__main__":
    ...
    json_message = {'data': {'deployment_selected': ['3 Counter Thrust'], 'dropped_all': ['player2'], 'game_date': ['2022-02-23'], 'map_selected': ['A7'], 'name': 'manual game report', 'objective_selected': ['4 King of the Hill'], 'player1_army': ["Highborn Elves\r\n900 - High Prince, General, Ancient Dragon, Light Armour, Great Weapon (Cleansing Light), Obsidian Rock\r\n515 - Mage, Wizard Master, Alchemy, Magical Heirloom, Talisman of the Void, Order of the Fiery Heart\r\n355 - Commander, Longbow (Elu's Heartwood), Battle Standard Bearer (Aether Icon, Aether Icon), Light Armour, Great Weapon, Queen's Companion\r\n669 - 27 Sea Guard, Standard Bearer (Flaming Standard), Musician, Champion\r\n275 - 5 Highborn Lancers, Standard Bearer (Flaming Standard), Musician, Champion\r\n185 - 5 Elein Reavers, Bow\r\n420 - 6 Knights of Ryma, Standard Bearer (Flaming Standard), Musician, Champion\r\n395 - Phoenix, Fire Phoenix\r\n216 - 9 Grey Watchers, Paired Weapons\r\n190 - Sea Guard Reaper\r\n190 - Sea Guard Reaper\r\n190 - Sea Guard Reaper\r\n4500"], 'player1_magic': ['H', 'A1', 'A2', 'A3', 'A4'], 'player1_name': ['Kaj Geenen "Chosen of Sigmar"'], 'player1_score': ['13'], 'player1_vps': ['3773'], 'player2_army': ["Dread Elves\r\n520 - Warlock Outcast, Wizard Master, Cosmology, Binding Scroll, Crystal Ball\r\n290 - Temple Exarch, Alchemy, Battle Standard Bearer, Seal of the Republic, Blades of Darag\r\n270 - Silexian Officer, General, Essence of Mithril, Paired Weapons (Hero's Heart), Lucky Charm\r\n603 - 37 Silexian Spears, Standard Bearer (Executioner's Icon), Musician, Champion\r\n270 - 15 Silexian Auxiliaries, Musician\r\n270 - 15 Silexian Auxiliaries, Musician\r\n458 - 19 Obsidian Guard, Champion, Musician, Standard Bearer\r\n395 - 3 Gorgons, Halberd\r\n180 - 5 Black Cloaks\r\n180 - 5 Black Cloaks\r\n420 - Hydra\r\n390 - Kraken\r\n250 - Mist Leviathan\r\n4496"], 'player2_magic': ['A1', 'C1', 'C4', 'C5', 'C6'], 'player2_name': ['Alfredo "Alfredini1"'], 'player2_score': ['7'], 'player2_vps': ['2748'], 'who_deployed': ['player2'], 'who_started': ['player2'], 'won_secondary': ['player2']}}
